...
# This script generates the synthetic data and runs MultiNest to find D and V
# with free knots.
...
# r.run_multinest(n_live_points=500)

# Run the inference with:
# $ mpiexec -np 24 python2.7 settings_1101014006_18.py