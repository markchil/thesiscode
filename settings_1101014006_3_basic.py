...
# This script generates the synthetic data with local measurements and runs
# MultiNest to infer D and V.
...
# Uncomment this line when you are ready to perform the inference:
# r.run_multinest()

# Run the inference with:
# $ mpiexec -np 24 python2.7 settings_1101014006_3.py
